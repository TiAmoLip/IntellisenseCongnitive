...
parser.add_argument('--hiddens', type=int, default=1024,
...
def evaluate(data_source):
    ...
    total_loss = 0.
    ntokens = len(corpus.dictionary)
    if args.model not in customModels:
...
if args.wandb:
    ...
    wandb.init(project="LM",name=args.run_name,config=args)
    wandb.config.update({"parameters":num_params})
