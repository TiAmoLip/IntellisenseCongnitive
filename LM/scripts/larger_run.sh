...
if [ $mode == "third" ]; then
    python main.py --data gigaspeech --cuda --epochs 40 --model L --optimizer --rope --hiddens 2048 --nlayers 12 --lr 0.003 --nhead 16 --embed_size 384 --wandb --run_name L_rope_adam_2048hid_12layers_16nhead_512embed
fi
